...
namespace Kader.Services.Utilities.Mappers.Profiles
{
    ...
    public class InsideUserViewProfile : Profile
    {
        private IMethods _methods;
        public InsideUserViewProfile()
        {
        ...
        {
            CreateMap<InsideUserViewDto, InsideUserView>();

        }
        private void QueryMapper()
        {
            CreateMap<InsideUserView, InsideUserViewDto>(); 
        }
    }
