...
namespace Kader.Controllers
{
    ...
    public class Qt3Controller : Controller
    {
        ...
        public Qt3Controller(IAuthenticateService userService, ICatogryService CatogryService, IHttpContextAccessor httpContextAccessor, ICookies cookies, IProductImgService ProductImgService, IProductService ProductService)
        {
        ...
        public async Task<IActionResult> Index(string categoryId3, int? page, string sortOrder, int? id)
        {
            ...
            var GetCatogry = await _Catogry.GetCatogry<ApiCatogryDto>(_httpContextAccessor.HttpContext, _keys.CatType_qta3a());
            ...
            if (token != null)
            {
                ...
                if (GetCatogry.isSuccess)
                {
                    ...
                    if (GetAllProduct.isSuccess)
                    {
                        ...
                        var GetProductByListProductApi = await _Product.GetProductByListProductApi(_httpContextAccessor.HttpContext, _keys.CatType_qta3a(), token, GetAllProductID, 0);
        ...
        public async Task<IActionResult> GetProductsByCategory(string categoryId3, int? page, string sortOrder, string id)
        {
            ...
            else if (!string.IsNullOrEmpty(categoryId3) || (id != null || id != "0"))
            {
                ...
                var GetProductByCatListApi = await _Product.GetProductsByCategoryser<ApiEditProductDto>(categoryIdsList, _keys.CatType_qta3a()); // Pass Type directly
